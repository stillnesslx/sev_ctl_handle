...
void Menu(uint8_t index,float parameter,u8 page)
{
 ...
 if(x_buf[5]!=0xff)
 {
  ...
  if(index==4)
 {
	OLED_ShowCHinese(47,6,22,0);		
	OLED_ShowCHinese(63,6,22,0);
	OLED_ShowCHinese(79,6,22,0);
	OLED_ShowCHinese(95,6,22,0);
	OLED_ShowCHinese(111,6,22,0);
 }else if(index==5)
 {
	OLED_ShowCHinese(47,3,22,0);		
	OLED_ShowCHinese(63,3,22,0);
	OLED_ShowCHinese(79,3,22,0);
	OLED_ShowCHinese(95,3,22,0);
	OLED_ShowCHinese(111,3,22,0);
